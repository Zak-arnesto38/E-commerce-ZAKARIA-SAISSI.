            ...
            <div class="col-md-12">
                <div class="card-deck">
                    <div class="card mt-4 p-1">
                        <div class="card-body">
                            <h5 class="card-header bg-dark text-white">Boutique</h5>
                            <div class="card-deck">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p><span class="badge badge-success"><?php echo $product['product_price'].'dh';?>
                                        </span>  <span class="text-danger"><strike><?php echo $product['old_price'].'dh';?></strike></span></p>
